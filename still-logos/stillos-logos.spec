...
%description
The stillos-logos package contains various image files which can be
...
mkdir -p %{buildroot}%{_datadir}/firstboot/themes/stillos
for i in firstboot/* ; do
  install -p -m 644 $i %{buildroot}%{_datadir}/firstboot/themes/stillos
done
