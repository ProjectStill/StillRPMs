...
Source2:	README.stillOS-Release-Notes
...
Provides: 	stillos-release
Provides: 	stillos-release-variant
Provides: 	stillos-release-identity
...
Requires: 	stillos-release-common = %{version}-%{release}

%description
stillOS release files such as yum configs and various /etc/ files that
...
Requires:   stillos-release-variant
Suggests:   stillos-release
...
%description notes
stillOS release notes package. This package explicitly is a replacement
...
echo "stillOS release %{version} (%{release_name})" > %{buildroot}%{_prefix}/lib/fedora-release
echo "cpe:/o:risi:stillos:%{version}" > %{buildroot}%{_prefix}/lib/system-release-cpe
...
# There are no separate editions for stillos-release
...
# Install readme
mkdir -p readme
install -pm 0644 %{SOURCE3} readme/README.stillOS-Release-Notes
...
%files notes
%doc readme/README.stillOS-Release-Notes
